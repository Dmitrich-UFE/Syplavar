...
public class TaskScript10 : MonoBehaviour
{
    ...
    {
        if (msg.Tag == "GETITEM" && taskManager.Status % 2 != 0 && inventory.CheckCountOfItemByID(105) > 5 && inventory.CheckCountOfItemByID(106) > 2 
        && (inventory.CheckCountOfItemByID(50) + inventory.CheckCountOfItemByID(51) + inventory.CheckCountOfItemByID(52) +
        inventory.CheckCountOfItemByID(53) + inventory.CheckCountOfItemByID(54) + inventory.CheckCountOfItemByID(55)
